...
const Register = () => {
  ...
  return (
    <div className="Register flex flex-row flex-wrap justify-center gap-[100px] laptop:gap-[300px] mt-[70px] items-center overflow-hidden relative py-[36px] mobile:py-[37px] tablet:py-[68px] px-0 laptop:px-[var(--desktop-x-padding)]">
